...
export const ErrorComponent = ({
	...
	return (
		<div className="absolute inset-0 flex items-center justify-center bg-black/40 overflow-hidden select-none touch-none">
			<div className="w-full h-full place-content-center p-6 bg-base-300/90 shadow-2xl flex flex-col items-center text-center gap-6 animate-in fade-in zoom-in duration-300">
